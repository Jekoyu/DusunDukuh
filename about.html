    ...
    <section class="about">
      <div class="about-img">
        <img
          ...
          alt="Kades"
          class="fade-in-image touch-animate-img"
        />
      </div>
      ...
      <div class="gallery-wrapper">
        <div class="gallery-container" id="gallery">
          <div
            class="gallery-item"
            style="
              background-image: url('assets/potensi/Poster\ Teras\ Seblak\ -\ By\ Muhamad\ Lutfi.jpeg');
            "
          ></div>
          <div
            class="gallery-item"
            style="
              background-image: url('assets/potensi/Social\ Media\ Graphic\ Design\ _\ Promo\ Ayam\ Geprek.jpeg');
            "
          ></div>
          <div
            class="gallery-item"
            style="
              background-image: url('assets/potensi/Mẫu\ Poster\ Lễ\ Hội\ ẩm\ Thực\ Sáng\ Tạo\ Tuyệt\ Vời\ Ai\ _\ EPS\ Tải\ xuống\ miễn\ phí\ -\ Pikbest.jpeg');
            "
          ></div>
          <div
            class="gallery-item"
            style="
              background-image: url('assets/potensi/Creative\ food\ design\ post.jpeg');
            "
          ></div>
          <div
            class="gallery-item"
    ...
    <section id="category-program">
      <div class="container-program">
        ...
        <div class="row mt-4">
          ...
          <div class="col-md-4">
            <img
              class="img-fluid mt-2 rounded-4"
              src="assets/program/image.png"
              alt="Poster"
              width="100%"
              height="100%"
            />
          ...
          <div class="col-md-8">
            <div class="ratio ratio-16x9 rounded-4 overflow-hidden mt-2">
              <iframe
                src="https://www.youtube.com/embed/DtjQ3R-_dGE"
                allowfullscreen
              ></iframe>
            </div>
          </div>
