        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li class="dropdown">
              ...
              ></a>
              <ul>
                <li><a href="Kel-Tani.html" class="active">Kel. Tani</a></li>
                <li><a href="Kel-Maggot.html">Kel. Maggot</a></li>
                <li><a href="Kel-Pemuda.html">Kel. Pemuda</a></li>
                <li><a href="PKK.html">PKK</a></li>
                <li><a href="LPMKAL.html">LPMKAL</a></li>
              </ul>
            </li>
        ...
        <div class="card-wrapper">
          <div class="card profile-card">
            ...
            <div class="profile-footer">
              <div class="profile-name">Era Natalia, S.I.P.</div>
              <div class="profile-role">Kepala Urusan Perencanaan</div>
            </div>
          </div>
          ...
          <div class="card profile-card">
            ...
            />
            <div class="profile-footer">
              <div class="profile-name">Arnani, S.I.P.</div>
              <div class="profile-role">Kepala Urusan Keuangan</div>
            </div>
          </div>
          ...
          <div class="card profile-card">
            ...
            />
            <div class="profile-footer">
              <div class="profile-name">Nopitasari, S.Pd.</div>
              <div class="profile-role">Kepala Urusan Tata Usaha dan Umum</div>
            </div>
          </div>
          ...
          <div class="card profile-card">
            ...
            />
            <div class="profile-footer">
              <div class="profile-name">Nama Keempat</div>
              <div class="profile-role">Jabatan Keempat</div>
            </div>
          </div>
        </div>
      </div>
