...
<body>
  ...
  <section class="page-header text-center">
    <div class="container">
      ...
      <p>Memajukan pertanian lokal melalui inovasi dan kerjasama untuk kesejahteraan petani dan ketahanan pangan</p>
    </div>
  </section>
  ...
  <div class="container">
    ...
    <section class="intro-section">
      <div class="row align-items-center">
        ...
        <div class="col-lg-8">
          <p class="lead mb-3">Kelompok Tani Dusun Dukuh adalah organisasi petani lokal yang berfokus pada pengembangan pertanian berkelanjutan dan peningkatan kesejahteraan anggotanya.</p>
          <p>Melalui berbagai program dan kegiatan, kelompok ini berupaya meningkatkan produktivitas pertanian dan kualitas hasil panen.</p>
    ...
    <section class="section-spacing" id="tentang">
      <div class="row">
        <div class="col-lg-6">
          ...
          <p class="mb-4">Kelompok Tani Dusun Dukuh dipimpin oleh Pak RW dan beranggotakan para petani lokal yang berdedikasi untuk memajukan sektor pertanian di daerah kami. Kelompok ini aktif dalam berbagai kegiatan pertanian dan program pengembangan kapasitas petani.</p>
          ...
          <div class="d-flex mb-4">
            ...
            <div>
              ...
              <p class="text-muted mb-0">Membangun kerjasama yang kuat antar petani untuk saling berbagi pengetahuan dan pengalaman dalam bertani.</p>
            </div>
          </div>
          ...
          <div class="d-flex mb-4">
            ...
            <div>
              ...
              <p class="text-muted mb-0">Menerapkan praktik pertanian yang ramah lingkungan dan berkelanjutan untuk menjaga kesuburan tanah.</p>
            </div>
          </div>
          ...
          <div class="d-flex">
            ...
            <div>
              ...
              <p class="text-muted mb-0">Berupaya meningkatkan pendapatan petani melalui diversifikasi tanaman dan peningkatan nilai tambah produk pertanian.</p>
            </div>
          </div>
        </div>
          ...
          <div class="tani-card">
            ...
            <div class="card-body">
              ...
              <div class="alert alert-success d-flex align-items-center" role="alert">
                ...
                <div>Program ini bertujuan untuk meningkatkan produksi bawang merah lokal dan kesejahteraan petani.</div>
              </div>
              ...
              <div class="mt-4">
                ...
                <div class="activity-item">
                  ...
                  <p class="mb-0">Penanaman bawang merah dengan teknologi terbaru untuk meningkatkan hasil panen dan kualitas produk.</p>
                </div>
                ...
                <div class="activity-item">
                  ...
                  <p class="mb-0">Pelatihan rutin untuk meningkatkan keterampilan petani dalam budidaya dan penanganan pasca panen.</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="section-spacing" id="struktur">
      ...
      <p class="text-muted mb-4">Kelompok Tani Dusun Dukuh dikelola oleh tim yang berpengalaman dan berdedikasi dalam pengembangan pertanian dan pengelolaan sumber daya alam.</p>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="card profile-card h-100">
            ...
            <div class="profile-footer">
              <div class="profile-name">Pak RW</div>
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="card profile-card h-100">
            ...
            />
            <div class="profile-footer">
              <div class="profile-name">Nama Wakil Ketua</div>
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="card profile-card h-100">
            <img
              src="assets/Staff/Bu_Rini.jpg"
              alt="Koordinator Lapangan"
              class="profile-img"
              style="height: 250px; object-fit: cover;"
            />
            <div class="profile-footer">
              <div class="profile-name">Nama Koordinator</div>
              <div class="profile-role">Koordinator Lapangan</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="tani-card">
            ...
            <div class="card-body">
              <p>Melalui bantuan PUDANA PUUPN MANDIRI, Kelompok Tani Dusun Dukuh fokus pada budidaya bawang merah dengan pendekatan modern dan berkelanjutan.</p>
              ...
              <div class="alert alert-warning d-flex align-items-center" role="alert">
                <i class="fas fa-info-circle me-2"></i>
                <div>Program ini sedang berjalan dan diharapkan panen pertama dapat dilakukan dalam 2-3 bulan ke depan.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-8 mx-auto">
          <div class="tani-card">
            ...
            <div class="card-body text-center">
              <p class="mb-4">Untuk informasi lebih lanjut tentang Kelompok Tani Dusun Dukuh atau ingin bergabung dengan kami, silakan hubungi:</p>
