    ...
    <section class="event m-5">
        ...
        <div class="event-wrapper" style="overflow-x: auto; white-space: nowrap; padding: 20px;">
            <div class="event-container d-inline-flex" id="event">
                ...
                ?>
                        <div class="event-item me-3" style="flex: 0 0 auto; width: 300px; height: 500px; background-image: url('assets/program/17 Agustusan.webp'); background-size: cover; background-position: center; border-radius: 10px;">
